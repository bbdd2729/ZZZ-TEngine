...
namespace InfinityCode.UltimateEditorEnhancer.Windows
{
    public partial class ViewGallery
    {
        public class CameraStateItem : ViewItem
        {
            ...
            public override bool isTemp { get; set; } = true;
            ...
            public override bool useInPreview
            {
                ...
                set
                {
                    ...
                    if (!value)
                    {
                        if (!camera.gameObject.GetComponent<HideInPreview>()) camera.gameObject.AddComponent<HideInPreview>();
                    }
            ...
            public override string name => camera ? camera.name : string.Empty;

            public CameraStateItem(Camera camera)
            {
                this.camera = camera;
                _useInPreview = !camera.gameObject.GetComponent<HideInPreview>();
            }
