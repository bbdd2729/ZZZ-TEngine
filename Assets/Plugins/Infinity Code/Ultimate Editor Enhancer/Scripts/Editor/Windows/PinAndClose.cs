...
namespace InfinityCode.UltimateEditorEnhancer.Windows
{
    public class PinAndClose : PopupWindow
    {
        ...
        public EditorWindow targetWindow => _targetWindow;
        ...
        protected override void OnGUI()
        {
            ...
            try
            {
                ...
                {
                    SetRect(_targetWindow.position, true);
                }
        ...
        private void SetRect(Rect rect, bool saveRect)
        {
            if (saveRect) targetRect = rect;
        ...
        public static PinAndClose Show(EditorWindow window, Rect inspectorRect, Action OnClose, Action OnLock = null, string label = null)
        {
            ...
            wnd.SetRect(inspectorRect, true);
