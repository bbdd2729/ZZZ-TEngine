        ...
        internal class ProjectRecord : Record
        {
            ...
            public override string label
            {
                get
                {
                    ...
                    if (_label.Length <= MaxLabelLength) return _label;
            ...
            public ProjectRecord(string path)
            {
                ...
                if (isDirectory)
                {
                    ...
                    {
                        info.Name,
                        path.Substring(7, path.Length - 8)
                    };
                }
                else
                {
            ...
            protected override void PrepareContextMenuExtraItems(GenericMenuEx menu)
            {
                ...
                if (type == "monoscript" && Selection.activeGameObject)
                {
            ...
            public override void Select(int state)
            {
                ...
                else if (state == -1 && type == "monoscript" && Selection.activeGameObject)
                {
