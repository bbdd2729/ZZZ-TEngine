...
namespace InfinityCode.UltimateEditorEnhancer
{
    ...
    public class LocalSettings : ScriptableObject
    {
        ...
        [SerializeField]
        private bool _autoCollapseEditors = false;
        ...
        public static bool autoCollapseEditors
        {
            get => instance._autoCollapseEditors;
            set
            {
                if (instance._autoCollapseEditors == value) return;
                instance._autoCollapseEditors = value;
                Save();
            }
        }
