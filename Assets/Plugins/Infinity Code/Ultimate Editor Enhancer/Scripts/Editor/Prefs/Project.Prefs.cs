...
namespace InfinityCode.UltimateEditorEnhancer
{
    public static partial class Prefs
    {
        ...
        public static bool projectCreateAnimationClip = true;
        public static bool projectCreateAnimatorController = true;
        ...
        public class ProjectManager : StandalonePrefManager<ProjectManager>, IHasShortcutPref, IStateablePref
        {
            ...
            public override void Draw()
            {
                ...
                projectCreateAnimationClip = EditorGUILayout.ToggleLeft("Create Animation Clip", projectCreateAnimationClip);
                projectCreateAnimatorController = EditorGUILayout.ToggleLeft("Create Animator Controller", projectCreateAnimatorController);
