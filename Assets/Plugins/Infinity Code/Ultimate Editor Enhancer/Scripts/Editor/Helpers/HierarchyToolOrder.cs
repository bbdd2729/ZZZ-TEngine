...
namespace InfinityCode.UltimateEditorEnhancer
{
    ...
    {
        public const int DropCopyComponent = -1000;
        public const int Background = -50;
        public const int OddEven = -45;
        public const int Header = -40;
        public const int MissingScript = -20;
        public const int Error = -10;
        public const int Note = -5;
        public const int BestIcon = 0;
        public const int Bookmark = 10;
        public const int ComponentIcon = 20;
        public const int RowEnable = 20;
