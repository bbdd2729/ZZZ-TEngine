...
namespace InfinityCode.UltimateEditorEnhancer
{
    public static class Icons
    {
        ...
        private static Texture _missingComponent;
        ...
        public static Texture missingComponent
        {
            get
            {
                if (_missingComponent == null) _missingComponent = ResourcesCache.GetIcon("Missing-Component");
