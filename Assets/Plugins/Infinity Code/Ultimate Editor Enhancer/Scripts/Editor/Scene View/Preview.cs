...
namespace InfinityCode.UltimateEditorEnhancer.SceneTools
{
    ...
    public static class Preview
    {
        ...
        public static bool isActive => texture;
        ...
        static Preview()
        {
            ...
            binding.OnValidate += () =>
            {
                ...
                if (!SceneView.lastActiveSceneView) return false;
        ...
        private static void StartPreview()
        {
            ...
            SceneViewState[] states = ViewStateReferences.items;
            for (int i = 0; i < states.Length; i++)
            {
                SceneViewState state = states[i];
        ...
        public class ViewStateItem : PreviewItem
        {
            ...
            public ViewStateItem(SceneViewState state)
            {
                this.state = state;
            }
