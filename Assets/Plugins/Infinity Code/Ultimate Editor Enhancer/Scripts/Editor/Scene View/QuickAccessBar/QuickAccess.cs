...
namespace InfinityCode.UltimateEditorEnhancer.SceneTools
{
    ...
    public static class QuickAccess
    {
        ...
        public static EventModifiers invokeItemModifiers;
        ...
        public static bool visible
        {
            get
            {
                ...
                return QuickAccessReferences.Any(i => i.Visible(maximized));
            }
        }
            ...
            foreach (QuickAccessItem item in QuickAccessReferences.items)
            {
                ...
                if (buttonEvent == ButtonEvent.press)
                {
                    if (e.button == 0)
                    {
                        ...
                        invokeItemModifiers = e.modifiers;
                        invokeItemAction = item.Invoke;
                        EditorApplication.update += InvokeItemAction;
                        e.Use();
                    }
                    else if (e.button == 1) item.ShowContextMenu();
                }
        ...
        public static void ShowContextMenu(GenericMenuEx menu = null)
        {
            if (menu == null) menu = GenericMenuEx.Start();
