...
namespace InfinityCode.UltimateEditorEnhancer.HierarchyTools
{
    ...
    public static class SoloVisibility
    {
        ...
        {
            HierarchyItemDrawer.Register(nameof(SoloVisibility), WaitRightClickOnEye, HierarchyToolOrder.SoloVisibility);
        }
        ...
        private static void WaitRightClickOnEye(HierarchyItem item)
        {
            ...
            {
                const string tooltip = "Left click to toggle visibility of this GameObject.\nRight click to toggle visibility of all other GameObjects in the hierarchy.";
