...
namespace InfinityCode.UltimateEditorEnhancer.ProjectTools
{
    ...
    public static class ProjectCreateMaterialFromShader
    {
        ...
        {
            ProjectItemDrawer.Listener listener = ProjectItemDrawer.Register(nameof(ProjectCreateMaterialFromShader), DrawButton, ProjectToolOrder.CreateMaterialFromShader);
