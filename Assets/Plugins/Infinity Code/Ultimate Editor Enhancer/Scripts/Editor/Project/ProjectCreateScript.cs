...
namespace InfinityCode.UltimateEditorEnhancer.ProjectTools
{
    ...
    public static class ProjectCreateScript
    {
        ...
        {
            ProjectItemDrawer.Listener listener = ProjectItemDrawer.Register(nameof(ProjectCreateScript), DrawButton, ProjectToolOrder.CreateScript);
            listener.folderName = "Scripts";
        }
