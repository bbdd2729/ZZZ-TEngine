...
namespace InfinityCode.UltimateEditorEnhancer.UnityTypes
{
    public static class EditorGUIUtilityRef
    {
        ...
        private static FieldInfo _editorHeaderItemsMethods;
        ...
        public static FieldInfo editorHeaderItemsMethodsField
        {
            get
            {
                if (_editorHeaderItemsMethods == null) _editorHeaderItemsMethods = type.GetField("s_EditorHeaderItemsMethods", Reflection.StaticLookup);
                return _editorHeaderItemsMethods;
            }
        }
