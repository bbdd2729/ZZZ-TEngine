...
namespace InfinityCode.UltimateEditorEnhancer.UnityTypes
{
    public static class TreeViewControllerRef
    {
        ...
        public static FieldInfo useExpansionAnimationField
        {
            get
            {
                if (_useExpansionAnimation == null) _useExpansionAnimation = type.GetField("m_UseExpansionAnimation", Reflection.InstanceLookup | BindingFlags.FlattenHierarchy);
        ...
        public static Type type
        {
            get
            {
                if (_type == null)
                {
                    ...
                    _type = Reflection.GetEditorType("IMGUI.Controls.TreeViewController`1");
                    _type = _type.MakeGenericType(typeof(EntityId));
#elif UNITY_6000_2_OR_NEWER
                    _type = Reflection.GetEditorType("IMGUI.Controls.TreeViewController`1");
                    _type = _type.MakeGenericType(typeof(int));
#else
                    _type = Reflection.GetEditorType("IMGUI.Controls.TreeViewController");
#endif
                }
                return _type;
            }
        ...
        public static MethodInfo userInputChangedExpandedStateMethod
        {
            get
            {
                if (_userInputChangedExpandedStateMethod == null)
                {
                    _userInputChangedExpandedStateMethod = type.GetMethod("UserInputChangedExpandedState", Reflection.InstanceLookup);
                }
